...
# hourly data sumarized by using the median, split: 80-20
$BASE_DIR/python_code/tools/split_classification_dataset.py -f $BASE_DIR/dataset/transformed/classification/features_all_1H_median_standarized_zscore_outliers_no.csv
$BASE_DIR/python_code/tools/split_classification_dataset.py -f $BASE_DIR/dataset/transformed/classification/features_all_1H_median_standarized_zscore_outliers_yes.csv

# hourly data sumarized by using the median, split: 80-20 with adversarial validation
$BASE_DIR/python_code/tools/split_classification_dataset.py -f $BASE_DIR/dataset/transformed/classification/features_all_1H_median_standarized_zscore_outliers_no.csv -av yes
$BASE_DIR/python_code/tools/split_classification_dataset.py -f $BASE_DIR/dataset/transformed/classification/features_all_1H_median_standarized_zscore_outliers_yes.csv -av yes

# hourly data sumarized by using the median, split: 70-30
$BASE_DIR/python_code/tools/split_classification_dataset.py -f $BASE_DIR/dataset/transformed/classification/features_all_1H_median_standarized_zscore_outliers_no.csv -s 70:30
$BASE_DIR/python_code/tools/split_classification_dataset.py -f $BASE_DIR/dataset/transformed/classification/features_all_1H_median_standarized_zscore_outliers_yes.csv -s 70:30

# hourly data sumarized by using the median, split: 70-30 with adversarial validation
$BASE_DIR/python_code/tools/split_classification_dataset.py -f $BASE_DIR/dataset/transformed/classification/features_all_1H_median_standarized_zscore_outliers_no.csv -av yes -s 70:30
$BASE_DIR/python_code/tools/split_classification_dataset.py -f $BASE_DIR/dataset/transformed/classification/features_all_1H_median_standarized_zscore_outliers_yes.csv -av yes -s 70:30
